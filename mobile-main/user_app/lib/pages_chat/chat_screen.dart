...
import 'package:user_app/pages_chat/textandimagemodel/ImageChatHomepage.dart';
import 'package:user_app/pages_chat/textonlymodel/TextChatHomepage.dart';
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Center(child: const Text('Bot',style: TextStyle(fontSize: 40),)),
          actions: [
            IconButton(
