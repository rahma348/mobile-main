...
import 'package:user_app/pages_chat/api/gemini_apikey.dart';
...
class _ImagechatwidgetState extends State<Imagechatwidget> {
    ...
    try {
      ...
      final ImageSource? source = await showDialog<ImageSource>(
        ...
        builder: (context) => AlertDialog(
          title: const Text('Select Image Source',style: TextStyle(color: Color(0xff0C8A7D)),),
            ...
            child: ListBody(
              children: [
                GestureDetector(
                  child: const Row(
                    children: [
                      Icon(Icons.photo_library,color: Color(0xff0C8A7D),),
                      SizedBox(width: 20),
                      Text('Gallery',style: TextStyle(color: Color(0xff0C8A7D)),),
                    ],
                  ),
                  onTap: () {
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    child: const Row(
                      children: [
                        Icon(Icons.camera_alt_outlined,color: Color(0xff0C8A7D),),
                        SizedBox(width: 20),
                        Text('Camera',style: TextStyle(color: Color(0xff0C8A7D)),),
                      ],
                    ),
                    onTap: () {
  ...
  void _showError(String message) {
    showDialog<void>(
      ...
      builder: (context) {
        return AlertDialog(
          title: const Text('Something went wrong',style: TextStyle(color: Color(0xff0C8A7D)),),
          content: SingleChildScrollView(
          ...
          actions: [
            TextButton(
              ...
              child: const Text('OK',style: TextStyle(color: Color(0xff0C8A7D)),),
            )
          ],
        );
      },
  ...
  Widget build(BuildContext context) {
    final textFieldDecoration = InputDecoration(
      ...
      hintStyle: TextStyle(color:Color(0xff0C8A7D)),
                            ...
                            children: [
                              Card(
                                child: ListTile(
                                  ...
                                  title: const Text('Kidney Care',style: TextStyle(color: Color(0xff0C8A7D)),),
                              ...
                              ElevatedButton(
                                ...
                                child: const Text('Ask Me Anything',style: TextStyle(color: Color(0xff0C8A7D)),),
                              ),
                            ],
                          ),
                        ),
                ...
                if (!_loading)
                  ...
                  const SizedBox(
                    ...
                    child: LoadingIndicator(
                        ...
                        colors: [Color(0xff0C8A7D), Color(0xff0C8A7D), Color(0xff0C8A7D)],
                        ...
                        pathBackgroundColor: Color(0xff0C8A7D)),
                  ),
              ],
            ),
          ),
